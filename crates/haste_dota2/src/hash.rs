...
// TODO: run more tests with fx hash, and remove fnv1a if everything is
// plausible.
pub mod fnv1a {
...
// TODO: test speed of hash functions that produce u32 instead of u64, and test
// them for collisions too
